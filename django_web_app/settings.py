...
# print((f"Saving file to: {default_storage.url('profile_pics/addy_z12_1.jpg')}"))
...
# print(AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY,AWS_STORAGE_BUCKET_NAME,AWS_S3_FILE_OVERWRITE,AWS_S3_CUSTOM_DOMAIN,MEDIA_URL,STATIC_URL)